...
describe("Parsing horizontal commands", function() {
  ...
  it("should work with single coordinate", function() {
    ...
    assert.equal(commands[0].type, SVGPathData.HORIZ_MOVE_TO);
  ...
  it("should work with comma separated coordinates", function() {
    ...
    assert.equal(commands[1].type, SVGPathData.HORIZ_MOVE_TO);
    assert.equal(commands[1].x, '456');
    assert.equal(commands[2].type, SVGPathData.HORIZ_MOVE_TO);
    assert.equal(commands[2].x, '7890');
    assert.equal(commands[3].type, SVGPathData.HORIZ_MOVE_TO);
  ...
  it("should work with multiple command declarations", function() {
    ...
    assert.equal(commands[3].type, SVGPathData.HORIZ_MOVE_TO);
    assert.equal(commands[3].x, '9876');
    assert.equal(commands[4].type, SVGPathData.HORIZ_MOVE_TO);
    assert.equal(commands[4].x, '123');
    assert.equal(commands[5].type, SVGPathData.HORIZ_MOVE_TO);
    assert.equal(commands[5].x, '456');
    assert.equal(commands[6].type, SVGPathData.HORIZ_MOVE_TO);
    assert.equal(commands[6].x, '7890');
    assert.equal(commands[7].type, SVGPathData.HORIZ_MOVE_TO);
...
describe("Parsing vertical commands", function() {
  ...
  it("should work with single coordinate", function() {
    ...
    assert.equal(commands[0].type, SVGPathData.VERT_MOVE_TO);
    assert.equal(commands[0].relative, false);
  ...
  it("should work with comma separated coordinates", function() {
    ...
    assert.equal(commands[1].type, SVGPathData.VERT_MOVE_TO);
    assert.equal(commands[1].y, '456');
    assert.equal(commands[2].type, SVGPathData.VERT_MOVE_TO);
    assert.equal(commands[2].y, '7890');
    assert.equal(commands[3].type, SVGPathData.VERT_MOVE_TO);
  ...
  it("should work with multiple command declarations", function() {
    ...
    assert.equal(commands[3].type, SVGPathData.VERT_MOVE_TO);
    assert.equal(commands[3].y, '9876');
    assert.equal(commands[4].type, SVGPathData.VERT_MOVE_TO);
    assert.equal(commands[4].y, '123');
    assert.equal(commands[5].type, SVGPathData.VERT_MOVE_TO);
    assert.equal(commands[5].y, '456');
    assert.equal(commands[6].type, SVGPathData.VERT_MOVE_TO);
    assert.equal(commands[6].y, '7890');
    assert.equal(commands[7].type, SVGPathData.VERT_MOVE_TO);
