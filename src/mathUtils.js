/* eslint-disable no-mixed-operators,max-len,valid-jsdoc */
'use strict';
...
module.exports = { bezierAt, bezierRoot, assertNumbers, arcAt, annotateArcCommand, intersectionUnitCircleLine };
