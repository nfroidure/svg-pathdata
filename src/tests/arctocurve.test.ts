...
describe('Converting elliptical arc commands to curves', () => {
  ...
  test('should correctly handle rotated arcs', () => {
    ...
    expect(testArcToCurve('M 50 50 A 30 15 45 0 1 100 100')).toEqual(
      'M50 50C54.465819873852 45.534180126148 63.3573806914169 46.172565470658 73.3253175473055 51.6746824526945C83.2932544031941 57.1767994347311 92.8232005652689 66.7067455968059 98.3253175473055 76.6746824526945C103.827434529342 86.6426193085831 104.465819873852 95.534180126148 100 100',
    );

    // 90 degree rotation
    expect(testArcToCurve('M 30 30 A 30 15 90 0 1 80 80')).toEqual(
      'M30 30C34.465819873852 12.1367205045918 43.3573806914169 0.3953426395196 53.3253175473055 -0.8012701892219C63.2932544031941 -1.9978830179635 72.8232005652689 7.5320631441114 78.3253175473055 24.198729810778C83.827434529342 40.8653964774447 84.465819873852 62.1367205045918 80 80',
    );
